...
2. Последние публикации (выводит все статьи рандомно перемешав)
3. Вам может понравиться
4. Футер

###### Футер
1. О компании (Краткая информация/описание)
2. Услуги (в разработке)
...
1. Описание того, что включает и не включает услуга по статобработке.
2. Описание почему важно заказать расчеты у профессионалов в области статистики.
3. Заказать статобработку (кнопка Заказать)
4. Вам может понравиться.
